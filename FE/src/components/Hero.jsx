...
const Hero = () => {
  return (
    <div className="flex flex-col flex-grow h-[95%]">
        <div className="flex flex-col h-fit items-center mx-auto">
        ...
        <div className="flex flex-row justify-between px-10 mt-15">
            <div className="w-full max-w-xl">
                <div className="border-1 border-[#f9e86663] rounded-lg px-10 flex flex-col gap-6 py-10">
                    ...
                    <input type="text" className='border border-[#f9e86663] rounded-md w-full px-3 py-5 focus:border-[#f9e866] focus:border-2 focus:outline-none'  placeholder='Enter your URL here...'/>
                    <label className='flex gap-4'> <input type="checkbox" className='h-6 w-6 rounded-md border-[#f9e866] border-2 bg-transparent' />
                    <span className='cursor-pointer'>Use custom code</span>
                    </label>
                    <input type="text" className='border border-[#f9e86663] rounded-md w-full px-3 py-3 focus:border-[#f9e866] focus:border-2 focus:outline-none'  placeholder='Enter your custom short code...'/>
                    <button className='bg-[#f9e866] px-4 py-6 rounded-md flex flex-row items-center text-black gap-4 justify-center cursor-pointer hover:bg-[#f9e866de]'>
            ...
            <div className="w-full max-w-2xl">
                <div className="border-1 border-[#9cf9668d] rounded-lg px-10 flex flex-col gap-6 py-10">
                    ...
                    <div className="border-1 border-[#9cf9668d] px-4 py-2 rounded-md flex flex-row items-center">
                        <input type="text" className='w-full py-5 border-none focus:outline-none text-xl' readOnly value={"hello"}/>
